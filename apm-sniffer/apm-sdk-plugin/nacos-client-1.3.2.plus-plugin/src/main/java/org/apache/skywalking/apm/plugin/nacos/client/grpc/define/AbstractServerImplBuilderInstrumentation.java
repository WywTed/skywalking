...
public class AbstractServerImplBuilderInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String ENHANCE_CLASS = SHADED_PACKAGE + "io.grpc.internal.AbstractServerImplBuilder";
    ...
    public static final String ARGUMENT_TYPE = SHADED_PACKAGE + "io.grpc.ServerServiceDefinition";
